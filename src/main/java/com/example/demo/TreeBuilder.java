...
import com.santint.core.util.JSONUtil;
...
public class TreeBuilder {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("双重循环："+JSonUtils.toJSon(trees));
        List<TreeNode> trees_ = TreeBuilder.buildByRecursive(list);
        System.out.println("递归："+JSonUtils.toJSon(trees_));
